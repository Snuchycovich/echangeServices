...
public interface IPersonDB {
     ...
     * @return The list of all persons in this databse as an instance of java.util.Collection<Person>.
     ...
     * @return The list of all logins in this database as an instance of java.util.Collection<String>.
     * @throws Exception if a database access error occurs
     */
