...
public interface IPersonDB2 {
     ...
     */
    public int create (Person p, String password) throws Exception;

    // "R" operations

    /**
     * Returns the list of all persons in this database.
     * @return The list of all persons in this database as an instance of java.util.Collection<Person>.
